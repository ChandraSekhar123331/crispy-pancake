...
# if __name__ == "__main__":
    # with open("insertdata.sql") as insert_file:
            # reader = csv.DictReader(file)
            # for row in reader:
            ...
            #             user_name, emp_name, email_id, phone_number, emp_address, 
            #             emp_password, emp_role, salary
            #             ) VALUES
            #             ({row["user_name"]}, {row["emp_name"]}, row[""])
