...
const attendCrudService = require('../../../services/employee/attendant/crud');
...
const insert = function insert(req, res) {
  ...
  if (attendantRole == null) {
    return res.status(409).json({
      message: "attendantRole can't be null",
      code: -1,
      result: null,
    });
  }
  ...
  // Get the empId,
  // insert into Attendant table now.
